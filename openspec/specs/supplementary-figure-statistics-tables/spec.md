# supplementary-figure-statistics-tables Specification

## Purpose
Define the table-only supplementary statistics workflow used to assemble concrete descriptive and inferential values behind final manuscript figure panels.
