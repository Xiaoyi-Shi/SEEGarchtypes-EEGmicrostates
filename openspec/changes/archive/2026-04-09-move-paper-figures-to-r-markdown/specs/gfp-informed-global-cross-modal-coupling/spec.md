...
The system SHALL support exploratory follow-up analyses that test whether EEG microstate and transition effects on SEEG global metrics remain after accounting for EEG GFP, and SHALL present those outputs as supplementary mechanistic context through categorized tables and manifest metadata rather than Python-rendered supplementary figures.
